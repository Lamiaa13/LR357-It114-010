...
public class Problem4 extends BaseClass {
    ...
    private static void transformText(String[] arr, int arrayNumber) {
        ...
        for(int i = 0; i < arr.length; i++){
            ...
            String titleCasedText = titleCase.toString().trim();

            // Challenge 3 Trim leading/trailing spaces and remove duplicate spaces (already handled in split)
            String placeholderForModifiedPhrase = titleCasedText;
    ...
    public static void main(String[] args) {
        final String ucid = "lr357"; // <-- change to your UCID
